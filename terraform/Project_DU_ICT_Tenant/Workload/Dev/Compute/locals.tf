locals {
  ...
  development_vm_names = [
    ...
    "${var.tenant_name}-platform-${var.bu_name}-${var.environment}-devlopment-vm-03"
  ]
  development_vm_network_interface_names = [
    ...
    "${var.tenant_name}-platform-${var.bu_name}-${var.environment}-devlopment-vm-nic-03"
  ]
  development_vm_nic_ip_configuration_names = [
    ...
    "${var.tenant_name}-platform-${var.bu_name}-${var.environment}-devlopment-vm-nic-ipc-03"
  ]
  development_vm_computer_names = ["ictplthrbdevvm1", "ictplthrbdevvm2", "ictplthrbdevvm3"]
