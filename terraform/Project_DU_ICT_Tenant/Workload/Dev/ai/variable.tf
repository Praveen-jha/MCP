...
variable "bot_service_tags" {
  type        = map(string)
  description = "A map of key-value pairs to tag resources related to the Bot Service."
}
...
# The SKU of the Azure Bot Service.
variable "ai_bot_sku" {
  type        = string
...
# The unique Application (Client) ID of an Azure AD application.
variable "application_id" {
  type        = string
  description = "The Application (Client) ID of the Azure AD application used for authentication."
}
...
# The endpoint URL for the Azure Bot Service
variable "endpoint" {
  description = "The fully qualified endpoint URL for the Azure Bot Service, used to handle incoming and outgoing communication with the bot."
  type        = string
}
