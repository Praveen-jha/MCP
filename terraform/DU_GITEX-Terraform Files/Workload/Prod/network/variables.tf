...
# Variable to define the address prefixes for subnet Python app
variable "subnet_py_app_address_prefix" {
  type        = list(string)
...
# Variable to define the address prefixes for subnet Node app
variable "subnet_node_app_address_prefix" {
  type        = list(string)
