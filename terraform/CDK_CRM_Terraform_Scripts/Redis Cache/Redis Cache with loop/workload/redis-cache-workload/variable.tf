...
# New variable for Redis Cache configurations
variable "redis_cache_mapping" {
  description = "A map defining configurations for multiple Redis Cache including their private endpoint and DNS settings."
  type = map(object({
    name = string
    redis_cache = object({
