// variables.tf
// This file defines the input variables for the azurerm_windows_web_app_slot module.

variable "web_app_slot_name" {
  type        = string
  description = "(Required) The name which should be used for this Windows Web App Slot."
}

variable "app_service_id" {
  type        = string
  description = "(Required) The ID of the Windows Web App this Deployment Slot will be part of."
}
