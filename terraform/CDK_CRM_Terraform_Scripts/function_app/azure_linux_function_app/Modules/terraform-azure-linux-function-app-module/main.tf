# Terraform configuration for an Azure Linux Function App module
...
resource "azurerm_linux_function_app" "this" {
  ...
  site_config {
    ...
    # health_check_grace_period_seconds             = var.site_config.health_check_grace_period_seconds
    ...
    dynamic "scm_ip_restriction" {
      for_each = var.site_config.scm_ip_restrictions != null ? var.site_config.scm_ip_restrictions : []
      content {
