...
#Description:A resource group is a collection of resources such as virtual machines, storage accounts, and more, that are deployed and managed together in Azure
