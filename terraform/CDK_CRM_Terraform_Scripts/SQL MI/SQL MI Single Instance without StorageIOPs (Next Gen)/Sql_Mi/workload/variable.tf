...
# Grouped base configuration for SQL MI
variable "sql_mi_base" {
  description = "Base configuration for SQL Managed Instance"
  type = object({
...
# Configuration settings for SQL Managed Instance
variable "sql_mi_config" {
...
# SKU settings for SQL Managed Instance
variable "sku" {
...
variable "existing_private_endpoint_subnet_name" {
  type        = string
  description = "Name of the Existing Private Endpoint Subnet for App Service"
}
