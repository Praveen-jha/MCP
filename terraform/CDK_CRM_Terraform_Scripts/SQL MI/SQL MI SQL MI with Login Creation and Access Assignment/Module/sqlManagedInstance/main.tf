...
resource "azurerm_mssql_managed_instance" "sql-mi" {
  ...
  administrator_login          = var.azuread_authentication_only_enabled == false ? var.administrator_login : null
  administrator_login_password = var.azuread_authentication_only_enabled == false ? var.administrator_login_password : null
