...
data "azurerm_resource_group" "existing_resource_group_servicebus" {
  count = var.name_config.servicebus_resource_group_creation == "existing" ? 1 : 0
  name  = var.existing_resource_group_servicebus_name
}
