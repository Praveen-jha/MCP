...
variable "data_disk_luns" {
  description = "A list of LUNs for the data disks to be attached to the SQL VM."
  type        = list(number)
  default     = []
}

variable "log_disk_luns" {
  description = "A list of LUNs for the log disks to be attached to the SQL VM."
  type        = list(number)
  default     = []
}

variable "tempdb_disk_luns" {
  description = "A list of LUNs for the tempdb disks to be attached to the SQL VM."
  type        = list(number)
  default     = []
}
