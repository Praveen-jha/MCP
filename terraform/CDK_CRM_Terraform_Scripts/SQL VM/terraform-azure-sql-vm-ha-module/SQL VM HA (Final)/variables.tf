...
variable "name" {
  description = "A list of names for each replica, in order."
  type        = list(string)
  default = [
    "dbsrv-01",
    "dbsrv-02"
...
variable "db_tempdb_disk_caching" {
  type        = string
  description = "Caching type for data disks (e.g., 'ReadWrite', 'None')."
  default     = "None"
}
...
variable "cluster_ip" {
  type        = string
  description = "Static IP Address of the Cluster"
}

variable "storage_account_name" {
  type        = string
  description = "Name of the Storage Account to be used for Cloud Witness"
}
...
variable "availability_group_name" {
  type        = string
  description = "Name of the Avialability Group"
}

variable "listener_name" {
  type        = string
  description = "Name of the Listener to be created."
}

variable "listener_ip" {
  type        = string
  description = "Static IP Address of the Listener"
}
