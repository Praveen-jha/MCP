...
data "azurerm_cognitive_account" "trsl" {
  name                = var.translator_service_name
  resource_group_name = var.ai_resource_group_name
}

data "azurerm_storage_account" "tfstate" {
  name                 = var.storage_account_name_tfstate
  resource_group_name  = var.tfstate_storage_account_resource_group
}
