locals {
  ...
  diagnostic_setting_py_app_name   = "${var.tenant_name}-platform-gitex-${var.environment}-py-app-diagnostics"
  diagnostic_setting_node_app_name = "${var.tenant_name}-platform-gitex-${var.environment}-node-app-diagnostics"

  action_group_name          = "${var.tenant_name}-platform-gitex-${var.environment}-action-group"
  action_group_shortname     = "AppServiceAG"
  metric_alert_frontend_name = "${var.tenant_name}-platform-gitex-${var.environment}-node-app-alert"
  metric_alert_backend_name  = "${var.tenant_name}-platform-gitex-${var.environment}-py-app-alert"
