...
variable "speech_service_tags" {
  description = "Tags for Speech Service"
  type        = map(string)
  default     = {}
}

variable "speech_rg_location" {
  description = "Location for the Speech Service"
  type        = string
}
