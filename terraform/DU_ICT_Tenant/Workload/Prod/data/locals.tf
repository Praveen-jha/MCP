locals {
  ...
  key_names               = ["ict-platform-hrbot-adls-cmk", "ict-platform-hrbot-cosmos-cmk", "ict-platform-hrbot-cosno-cmk", "ict-platform-hrbot-bot-cmk", "ict-platform-hrbot-di-cmk", "ict-platform-hrbot-oai-cmk"]
  ...
  secrets = [
    {
      secret_name  = "ict-platform-hrbot-prod-database-cosno-keys"
      secret_value = "${module.cosmos_nosql.cosmos_db_key}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-database-cosno-connection-string"
      secret_value = "${module.cosmos_nosql.cosmos_db_connection_string}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-database-cosno-uri"
      secret_value = "${module.cosmos_nosql.cosmos_db_uri}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-di-keys"
      secret_value = "${data.azurerm_cognitive_account.di.primary_access_key}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-di-endpoint"
      secret_value = "${data.azurerm_cognitive_account.di.endpoint}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-srch-keys"
      secret_value = "${data.azurerm_search_service.srch.primary_key}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-srch-uri"
      secret_value = "https://ict-platform-hrbot-prod-srch.search.windows.net"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-oai-keys"
      secret_value = "${data.azurerm_cognitive_account.openai.primary_access_key}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-oai-endpoint"
      secret_value = "${data.azurerm_cognitive_account.openai.endpoint}"
    },
    {
      secret_name  = "ict-platform-ccai-oai-keys"
      secret_value = "1224bdb908784d0ca5dc5920810ccb7a "
    },
    {
      secret_name  = "ict-platform-ccai-oai-endpoint"
      secret_value = "https://ict-platform-ccai-oai.openai.azure.com/"
    },
    {
      secret_name  = "ict-platform-ccai-oai-model-endpoint"
      secret_value = "https://ict-platform-ccai-oai.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2024-08-01-preview"
    },
    {
      secret_name  = "ict-platform-ccai-oai-version"
      secret_value = "2024-08-06"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-database-cosmos-connection-string"
      secret_value = "${module.cosmos_mongodb.cosmos_db_connection_string}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-database-cosmos-keys"
      secret_value = "${module.cosmos_mongodb.cosmos_db_key}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-database-cosmos-uri"
      secret_value = "${module.cosmos_mongodb.cosmos_db_uri}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-appi-instrumentation-key"
      secret_value = "${data.azurerm_application_insights.appi.instrumentation_key}"
    },
    {
      secret_name  = "ict-platform-hrbot-prod-appi-connection-string"
