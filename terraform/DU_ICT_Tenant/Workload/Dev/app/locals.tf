locals {
  ...
  node_app_service_plan_uat_name   = "${var.tenant_name}-platform-${var.bu_name}-uat-node-app-asp"
  node_app_service_uat_name        = "${var.tenant_name}-platform-${var.bu_name}-uat-node-app"
  python_app_service_plan_uat_name = "${var.tenant_name}-platform-${var.bu_name}-uat-py-app-asp"
  python_app_service_uat_name      = "${var.tenant_name}-platform-${var.bu_name}-uat-py-app"

  python_deployment_slot_name = "test"
